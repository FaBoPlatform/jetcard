...
sudo -H pip3 install -U numpy grpcio absl-py py-cpuinfo psutil portpicker six mock requests gast h5py==2.10.0 astor termcolor protobuf keras-applications keras-preprocessing wrapt google-pasta
